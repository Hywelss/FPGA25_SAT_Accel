set source_root $::env(DELETE_COSIM_SOURCE_ROOT)
set project_dir $::env(DELETE_COSIM_PROJECT)
...
add_files -cflags $include_flags "$source_root/tests/clause_store_delete_cosim_top.cpp"
add_files -tb -cflags $include_flags "$source_root/tests/clause_store_delete_cosim_test.cpp"
