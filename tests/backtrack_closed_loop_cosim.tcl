set source_root $::env(BACKTRACK_CLOSED_LOOP_SOURCE_ROOT)
set project_dir $::env(BACKTRACK_CLOSED_LOOP_PROJECT)
...
set_top undo_states_dataflow_wrapper
...
add_files -tb -cflags $include_flags \
    "$source_root/tests/backtrack_closed_loop_cosim_test.cpp"

open_solution -reset solution
set_part {xcvc1902-vsvd1760-2MP-e-S}
create_clock -period 5
config_rtl -deadlock_detection sim
set_directive_interface -mode axis undo_states_dataflow_wrapper pqHandlerInput
set_directive_array_partition -type complete -dim 1 \
    undo_states_dataflow_wrapper clsStates
csim_design
csynth_design
