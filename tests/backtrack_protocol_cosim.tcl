...
set project_dir $::env(BACKTRACK_COSIM_PROJECT)
...
add_files -tb -cflags $include_flags "$source_root/tests/backtrack_protocol_test.cpp"

open_solution -reset solution
set_part {xcvc1902-vsva2197-2MP-e-S}
create_clock -period 5
config_rtl -deadlock_detection sim
set_directive_interface -mode axis updateStatesBackward toStateUpdater
set_directive_interface -mode ap_memory -depth 16384 updateStatesBackward clsStates
