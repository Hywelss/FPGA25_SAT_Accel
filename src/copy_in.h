...
void copy_clsStore(ap_uint<512> mClsStore[_FPGA_MAX_LITERAL_ELEMENTS/LIT_SLOTS_PER_WORD], ap_uint<512>* clauseStore, const unsigned int clauseElements);
...
void copy_litStore(ap_uint<512> mLitStore[(_FPGA_MAX_LITERAL_ELEMENTS/LIT_SLOTS_PER_WORD)/2], ap_int<512>* litStore, const unsigned int literalElements);
