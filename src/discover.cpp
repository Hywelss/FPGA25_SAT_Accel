...
#if defined(OCC_DDR_STREAMED)
    colorStream(toStateUpdater, toColorStream, &stopSending, litStore, litStoreDDR, occCacheTag, occReq, occResp, LITERAL_PAGE_SIZE, &literalCommit, 0, litStoreAccessStats);
